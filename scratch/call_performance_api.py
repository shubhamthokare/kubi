...
def main():
    ...
    login_url = "http://backend.kubi.kontactless.in/api/auth/login"
    ...
    try:
        ...
        stats_url = "http://backend.kubi.kontactless.in/api/stats"
        print(f"\nCalling {stats_url}...")
        ...
        perf_url = "http://backend.kubi.kontactless.in/api/stats/performance"
        print(f"\nCalling {perf_url}...")
